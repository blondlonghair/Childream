...
public class TutorialEffectManager : SingletonMonoDestroy<TutorialEffectManager>
{
    ...
    IEnumerator EffectAtk1Update(GameObject _caster, GameObject _target, Vector3 _targetPos, params GameObject[] _effect)
    {
    ...
    IEnumerator EffectAtk2Update(GameObject _caster, GameObject _target, Vector3 _targetPos, params GameObject[] _effect)
    {
    ...
    IEnumerator EffectAtk3Update(GameObject _caster, GameObject _target, Vector3 _targetPos, params GameObject[] _effect)
    {
    ...
    IEnumerator EffectDefUpdate(GameObject _caster, GameObject _target, Vector3 _targetPos, params GameObject[] _effect)
    {
    ...
    IEnumerator EffectSup1Update(GameObject _caster, GameObject _target, Vector3 _targetPos, params GameObject[] _effect)
    {
    ...
    IEnumerator EffectSup2Update(GameObject _caster, GameObject _target, Vector3 _targetPos, params GameObject[] _effect)
    {
        GameObject effectObj = Instantiate(_effect[0], _caster.transform.position, Quaternion.identity);
        yield return new WaitForSeconds(2);
    ...
    IEnumerator EffectSup3Update(GameObject _caster, GameObject _target, Vector3 _targetPos, params GameObject[] _effect)
    {
