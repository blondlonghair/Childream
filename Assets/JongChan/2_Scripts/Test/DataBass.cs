...
public class DataBass : MonoBehaviour
{
    const string URL = "https://script.google.com/macros/s/AKfycbwuWDPwEPmtYJaX9ygxgtV2xjZ4U7rBT_miPgu9epv_dBFXfAeKuSvgwIzP_y-F5fsJ4Q/exec";
